...
#define ADSP_CAVS_HOST_DSP_SRAM_BASE   \
	(ADSP_CAVS_MMIO_BASE + 0)

/* CAVS 1.5 */
#define ADSP_CAVS_HOST_DSP_1_5_HP_SRAM_BASE  \
	(ADSP_CAVS_HOST_DSP_SRAM_BASE + ADSP_CAVS_1_5_DSP_SRAM_SIZE)

#define ADSP_CAVS_HOST_DSP_1_5_LP_SRAM_BASE  \
	(ADSP_CAVS_HOST_DSP_1_5_HP_SRAM_BASE + ADSP_CAVS_1_5_DSP_HP_SRAM_SIZE)

#define ADSP_CAVS_HOST_DSP_1_5_IMR_BASE \
	(ADSP_CAVS_HOST_DSP_1_5_LP_SRAM_BASE + ADSP_CAVS_1_5_DSP_LP_SRAM_SIZE)

#define ADSP_CAVS_HOST_1_5_ROM_BASE		\
	(ADSP_CAVS_HOST_DSP_1_5_IMR_BASE + ADSP_CAVS_1_5_DSP_IMR_SIZE)

/* CAVS 1.8 */
#define ADSP_CAVS_HOST_DSP_1_8_HP_SRAM_BASE  \
	(ADSP_CAVS_HOST_DSP_SRAM_BASE + ADSP_CAVS_1_8_DSP_SRAM_SIZE)

#define ADSP_CAVS_HOST_DSP_1_8_LP_SRAM_BASE  \
	(ADSP_CAVS_HOST_DSP_1_8_HP_SRAM_BASE + ADSP_CAVS_1_8_DSP_HP_SRAM_SIZE)

#define ADSP_CAVS_HOST_DSP_1_8_IMR_BASE \
	(ADSP_CAVS_HOST_DSP_1_8_LP_SRAM_BASE + ADSP_CAVS_1_8_DSP_LP_SRAM_SIZE)

#define ADSP_CAVS_HOST_1_8_ROM_BASE		\
	(ADSP_CAVS_HOST_DSP_1_8_IMR_BASE + ADSP_CAVS_1_8_DSP_IMR_SIZE)
...
/* SRAM Windows */
#define ADSP_CAVS_WND_SIZE			0x2000
#define ADSP_CAVS_HOST_1_5_SRAM_WND_BASE(x)  \
	(ADSP_CAVS_1_5_DSP_HP_SRAM_BASE + x * ADSP_CAVS_WND_SIZE)
...
/* SRAM Windows */
#define ADSP_CAVS_HOST_1_8_SRAM_WND_BASE(x)  \
	(ADSP_CAVS_1_8_DSP_HP_SRAM_BASE + x * ADSP_CAVS_WND_SIZE)
