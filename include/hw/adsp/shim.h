...
#define ILBLOCK_SIZE    0x10
#define ILMSD(x)        (0x0 + ILBLOCK_SIZE * (x - 2)) /* mask set - W1S */
#define ILMCD(x)        (0x4 + ILBLOCK_SIZE * (x - 2)) /* mask clear - W1C */
#define ILMC(x)         (0x8 + ILBLOCK_SIZE * (x - 2))  /* mask status - ROV */
#define ILSC(x)         (0xc + ILBLOCK_SIZE * (x - 2))  /* IRQ status - ROV after mask */
